...
class FormLoginDesign:
    ...
    def __init__(self):
        ...
        title = tk.Label(frame_form_top, text="Log In", font=(
        ...
        inicio = tk.Button(
            ...
            bd=0,
            fg="#fff",
            command=lambda: self.login_credentials(self.usuario.get(), self.password.get())
        )
        inicio.pack(fill=tk.X, padx=20, pady=20)
        
        inicio = tk.Button(frame_form_fill, text="Crear cuenta nueva", font=(
            'Bold', 15), bg='#03F003', bd=0, fg="#fff", command=self.crear_cuenta)
        inicio.pack(fill=tk.X, padx=20, pady=20)
